package org.afrivera.springcloud.msvc.courses.exception;

import org.afrivera.springcloud.msvc.courses.dto.ErrorDetail;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetail> resourceNotFoundException(ResourceNotFoundException exception, WebRequest request){
        ErrorDetail errorDetail = new ErrorDetail(exception.getMessage(), HttpStatus.NOT_FOUND.value());
